 ...
 */
package io.github.photowey.riff.business.job.web.controller.openapi.job;
...
/**
 * {@code OpenAPIScheduleJobController}.
 *
 * @author photowey
 * @version 1.0.0
 * @since 2025/08/08
...
@Slf4j
@RestController
@RequestMapping("/openapi/v1/schedule/job")
@SuppressWarnings("all")
public class OpenAPIScheduleJobController {
     ...
     *
     * @param payload The request payload containing registration data, of type {@link ScheduleJobAddPayload}.
     * @return Returns An {@link ApiResult} encapsulating a {@link ScheduleJobDTO} object.
     */
    @PostMapping("/register")
    public ApiResult<ScheduleJobDTO> register(@RequestBody @Validated ScheduleJobAddPayload payload) {
