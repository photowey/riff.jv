 ...
 */
package io.github.photowey.riff.business.uaa.web.config;
...
/**
 * {@code UaaWebappAutoConfiguration}.
 *
 * @author photowey
 * @version 1.0.0
 * @since 2025/07/22
...
@AutoConfiguration
@Import(value = {
    UaaWebappAutoConfiguration.UaaWebappConfiguration.class,
})
public class UaaWebappAutoConfiguration {
