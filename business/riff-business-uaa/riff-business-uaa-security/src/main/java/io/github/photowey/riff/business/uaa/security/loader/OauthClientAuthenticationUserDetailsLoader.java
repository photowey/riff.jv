...
/**
 * {@code OauthClientAuthenticationUserDetailsLoader}.
 *
 * @author photowey
 * @version 1.0.0
 * @since 2025/07/22
 */
@Slf4j
public class OauthClientAuthenticationUserDetailsLoader extends AbstractAuthenticationUserDetailsLoader {
    ...
    public String protocol() {
        return AuthorityConstants.OAUTH_CLIENT_PROTOCOL;
    }

    @Override
    public AuthenticationPrincipal toAuthenticatedPrincipal(Username proxy) {
        LoadOauthClientAuthenticatedPrincipalEvent event = new LoadOauthClientAuthenticatedPrincipalEvent(proxy);
