...
public class JwtAccessDeniedHandler implements AccessDeniedHandler {
    ...
    public void handle(
        ...
        if (Objects.isNotNull(accessDeniedException.getCause())
            && accessDeniedException.getCause() instanceof FormattableException exception) {
            Responsers.doResponse(exception.toExceptionBody());

            return;
        }

        Responsers.doResponse(ExceptionStatus.FORBIDDEN);
    }
}
