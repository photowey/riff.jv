...
public class IocAutoConfiguration {
    ...
    @Bean
    public BeanFactoryInjector beanFactoryInjector() {
        return new BeanFactoryInjector();
    }
    ...
    @Bean
    @ConditionalOnMissingBean(EntityValidator.class)
    public EntityValidator entityValidator(LocalValidatorFactoryBean factoryBean) {
        return new DefaultEntityValidator(factoryBean);
    }
}
