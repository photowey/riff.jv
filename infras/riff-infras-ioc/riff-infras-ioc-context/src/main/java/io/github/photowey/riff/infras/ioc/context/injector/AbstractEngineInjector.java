 ...
 * @since 2025/07/16
 */
public abstract class AbstractEngineInjector<E extends Engine, A extends EngineAware>
    extends AbstractEngineAwareBeanFactoryPostProcessor<E, A> { }
