 ...
 */
package io.github.photowey.riff.infras.common.nanoid;
...
public final class NanoId {
    ...
    public static final char[] PASSWORD_ALPHABET =
        "23456789abcdefghjkmnpqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ".toCharArray();
    public static final char[] NANOID_ALPHABET =
        "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".toCharArray();
    public static final char[] NANOID_LOWER_ALPHABET =
    ...
    public static final char[] ALPHABET_NUMBER_WITH_ZERO =
        ALPHABET_NUMBER_WITH_ZERO_STRING.toCharArray();
    ...
    private NanoId() {
        AssertionErrors.throwz(NanoId.class);
    }
    ...
    public static String randomLowerNanoId() {
        return randomNanoId(DEFAULT_NUMBER_GENERATOR, NANOID_LOWER_ALPHABET,
    ...
    public static String randomNumberNanoId() {
        return randomNanoId(DEFAULT_NUMBER_GENERATOR, NANOID_NUMBER_ALPHABET,
            NanoIdUtils.DEFAULT_SIZE);
    }
